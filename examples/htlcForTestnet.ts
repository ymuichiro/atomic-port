...
function clients() {
  return {
    evmClient: new HTLCService(Contracts.sepolia.native.endpoint, Contracts.sepolia.native.contractAddress),
...
async function evmMint(client: HTLCService, hashPair: HashPair) {
...
async function evmWithDraw(client: HTLCService, contractId: string, toAddress: string, hashPair: HashPair) {
