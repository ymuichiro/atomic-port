...
interface IEvmService {
    ...
    mint(recipientAddress: string, senderAddress: string, lockSeconds: number, amountOrTokenId: number, gasLimit: number, tokenAddress: string | undefined): Promise<object>;
