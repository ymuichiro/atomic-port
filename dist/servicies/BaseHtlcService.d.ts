 ...
 */
declare class BaseHtlcService implements IEvmService {
    web3: Web3;
     ...
     */
    mint(recipientAddress: string, senderAddress: string, lockSeconds: number, amount: number, gasLimit: number): Promise<object>;
    /**
