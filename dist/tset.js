...
const network = new Network_1.Network("testnet", 0x98, new Date(Date.UTC(2022, 9, 31, 21, 7, 47)), new CryptoTypes_1.Hash256("49D6E1CE276A85B70EAFE52349AACCA389302E7A9754BCF1221E79494FC665A4"));
const symbolService = new SymbolService_1.default(network, node);
symbolService.secretLockTransaction(privateKey, recipientAddress, 0x72c0212e67a08bcen, // mosaicId
1n, // amount
5760n // duration
);
